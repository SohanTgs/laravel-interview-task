...
<div class="container" id="item-box">
		<div class="row">
			<div class="col-md-6" id="image-item">
				<h4>Post a new content here.......<span style="color:red;font-size:30px;font-style:italic;">{{ Session::get('message') }}</span></h4><br/>
		<form action="{{ route('save_new_post') }}" method="POST" enctype="multipart/form-data">
					...
					<input type="text" id="post_title" name="post_title" class="form-control"><br/>
					...
					<input type="file" id="post_file" accept="*" name="post_file" class="form-control"><br/>
					<label></label><br/>
